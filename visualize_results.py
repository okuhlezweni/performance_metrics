...
.metric {{ background:white; border:1px solid var(--line); padding:16px; min-height:112px; display:flex; flex-direction:column; justify-content:space-between; }}
...
@media (max-width:650px) {{ main {{ padding:30px 16px 48px; }} header {{ display:block; }} .meta {{ text-align:left; margin-top:18px; }} }}
</style>
</head>
